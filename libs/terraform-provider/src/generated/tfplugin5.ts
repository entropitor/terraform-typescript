...
export interface ProtoGrpcType {
  tfplugin5: {
    ...
    Provider: SubtypeConstructor<typeof grpc.Client, _tfplugin5_ProviderClient> & { service: ServiceDefinition }
    ProvisionResource: MessageTypeDefinition
    Provisioner: SubtypeConstructor<typeof grpc.Client, _tfplugin5_ProvisionerClient> & { service: ServiceDefinition }
