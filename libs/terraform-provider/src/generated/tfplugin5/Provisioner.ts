...
export interface ProvisionerClient extends grpc.Client {
  GetSchema(
    argument: _tfplugin5_GetProvisionerSchema_Request,
    metadata: grpc.Metadata,
    options: grpc.CallOptions,
    callback: (
      error?: grpc.ServiceError,
      result?: _tfplugin5_GetProvisionerSchema_Response__Output,
    ) => void,
  ...
  ProvisionResource(
    argument: _tfplugin5_ProvisionResource_Request,
    metadata: grpc.Metadata,
    options?: grpc.CallOptions,
  ): grpc.ClientReadableStream<_tfplugin5_ProvisionResource_Response__Output>;
  ProvisionResource(
    argument: _tfplugin5_ProvisionResource_Request,
    options?: grpc.CallOptions,
  ): grpc.ClientReadableStream<_tfplugin5_ProvisionResource_Response__Output>;
  ...
  ValidateProvisionerConfig(
    argument: _tfplugin5_ValidateProvisionerConfig_Request,
    metadata: grpc.Metadata,
    options: grpc.CallOptions,
    callback: (
      error?: grpc.ServiceError,
      result?: _tfplugin5_ValidateProvisionerConfig_Response__Output,
    ) => void,
  ): grpc.ClientUnaryCall;
  ValidateProvisionerConfig(
    argument: _tfplugin5_ValidateProvisionerConfig_Request,
...
export interface ProvisionerHandlers extends grpc.UntypedServiceImplementation {
  ...
  ProvisionResource: grpc.handleServerStreamingCall<
    _tfplugin5_ProvisionResource_Request__Output,
    _tfplugin5_ProvisionResource_Response
  >;
  ...
  ValidateProvisionerConfig: grpc.handleUnaryCall<
    _tfplugin5_ValidateProvisionerConfig_Request__Output,
    _tfplugin5_ValidateProvisionerConfig_Response
  >;
}
